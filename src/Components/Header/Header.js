...
export default function Header () {
  return(
    <div className='headerDiv' style={{position: 'relative'}}>
      ...
      <img className='headerIcon' style={{width: 'calc(100vw - (100vw - 100%))', height: '250%', position: 'absolute', zIndex: '-10', filter: 'invert(100%)'}} src="https://imageassociatesllc.com/wp-content/themes/oneup-ia/images/blackblur6.png" alt=""/>
    </div>
  )
}