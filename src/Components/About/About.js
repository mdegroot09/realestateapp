...
export default class About extends Component {
  render(){
    return(
      <div style={{paddingTop: '80px', backgroundImage: `url('https://simplejoys.s3.us-east-2.amazonaws.com/neighborhood-1570799839221.jpg')`}}>
        <div style={{background: 'white', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center'}}>
          <div style={{minHeight: 'calc(100vh - 152px)', width: 'calc(100% - 50px)'}}>
